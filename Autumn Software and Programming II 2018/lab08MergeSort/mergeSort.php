...
$myArray=array(13 ,47 ,200, 53 ,0, 100 ,33, 8 ,31, 75, 123 ,47 ,99 );

  $array = mergeSort(count($myArray) ,$myArray);//1 8 4 13 99 23 17 7 25 ||   13 99 47 0 23 13 86 || 13 47 200 53 0 100 33 8 31 75 123 47 99 || 1 ,8 ,4, 13, 99, 23, 17, 7 ,25
  print_r( $array).'<br>';
